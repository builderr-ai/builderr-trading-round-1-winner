# Arnav's Round 1 trading agent

The public Builderr archive for Arnav Chauhan's winning Trading Agent Round 1 submission.
...
```bash
python preview.py arnav_agent.py
```
...
- [`arnav_agent.py`](arnav_agent.py) — submitted agent source, kept unchanged
