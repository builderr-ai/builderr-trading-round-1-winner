...
This archive supports the claim that the submitted agent won one dated Builderr paper-trading
challenge window. It does not support a claim of guaranteed returns, long-term alpha, or suitability
